    ...
    <div className="space-y-24 py-12">
      <div className="flex flex-col items-center justify-center min-h-[40vh] space-y-6 text-center animate-in fade-in zoom-in duration-700">
        ...
        <div className="flex gap-4 pt-6">
          <Button size="lg" className="h-14 px-10 text-lg rounded-full shadow-lg shadow-primary/20" onClick={() => navigate('/roadmap')}>
            View Learning Path
          </Button>
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-500">
      ...
      <div className="flex justify-center mt-12 mb-20">
        <Button size="lg" className="rounded-full px-8" onClick={() => navigate('/learn/1')}>
...
function ModuleView() {
  ...
  if (!currentTopic) return <Navigate to="/roadmap" />

  const CurrentComponent = currentTopic.componentId ? COMPONENT_MAP[currentTopic.componentId] : null

  const next = () => {
    if (currentStep < allTopics.length) {
      navigate(`/learn/${currentStep + 1}`)
    } else {
      navigate('/roadmap')
    }
  }
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="flex justify-between border-t border-border/50 pt-8 pb-12">
        ...
        <Button variant="outline" onClick={() => navigate('/roadmap')} className="flex gap-2 rounded-full">
  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/learn/:step" element={<ModuleView />} />
