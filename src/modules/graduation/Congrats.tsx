        ...
        <div className="flex flex-col items-center justify-center py-20 text-center space-y-8 relative overflow-hidden">
            ...
            <div className="space-y-4 px-4">
                <motion.h1 
                    ...
                    className="text-4xl md:text-5xl font-extrabold tracking-tight lg:text-7xl"
                >
            ...
            <motion.div 
                ...
                className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-lg pt-8 md:pt-12 px-8"
            >
